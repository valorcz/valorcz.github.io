...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b5f5885fdf46a57c5b7cdd8f1e5d3d9af799c3e1fdf99cc395c8860d38fad4d6.js',function(){input.required=false;search();});}
