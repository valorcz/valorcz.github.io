...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cb0c8285feb53def814a1ea0320a05c8915843251c08380f228ea5aed072efd3.js',function(){input.required=false;search();});}
